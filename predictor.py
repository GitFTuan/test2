...
def ArgsGet():
    parse = argparse.ArgumentParser(description='TCFAN')
    parse.add_argument('--file', type=str, default='test.fasta', help='fasta file')
    parse.add_argument('--out_path', type=str, default='TCFAN/result', help='output path')
...
def predict(test, seq_length, h5_model):
    dir = './TCFAN/dataset/KD_model/teacher/tea_model.pth'
    print('predicting...')
